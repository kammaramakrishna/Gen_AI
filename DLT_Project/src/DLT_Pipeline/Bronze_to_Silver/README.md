...
This folder defines all source code for the 'Bronze_to_Silver' pipeline:
...
* Take a look at the sample under "sample_users_bronze_to_silver.py" to get familiar with the syntax.
